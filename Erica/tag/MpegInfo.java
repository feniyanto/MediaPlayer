...
public class MpegInfo implements TagInfo
{
  ...
  protected String channelsMode = "TEST MODES";
  protected String version = "TEST VERSION";
  protected int rate = 0;
  protected String layer = "TEST LAYER";
  protected String emphasis = "TEST EMPHASIS";
  protected int nominalbitrate = 0;
  protected long total = 0;
  protected String vendor = "TEST VENDOR";
  protected String location = "TEST LOCATION";
  protected long size = 1234567;
  ...
  protected int track = 4;
  protected String year = "2/7/2012";
  protected String genre = "TEST GENRE";
  protected String title = "TEST TITLE";
  protected String artist = "TEST ARTIST";
  protected String album = "TEST ALBUM";
